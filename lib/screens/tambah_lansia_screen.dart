...
class _TambahLansiaScreenState extends State<TambahLansiaScreen> {
  ...
  void _handleSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      // Mimic HTML micro-interaction delay
                  ...
                  _SpringButton(
                    onTap: () {
                      ...
                      final age = _selectedDate != null
                          ? (DateTime.now().difference(_selectedDate!).inDays / 365).floor().toString()
                          : '65';

                      // Pass back the new patient map to be inserted dynamically
                      final newPatient = {
                      ...
                      Navigator.pop(context, newPatient); // Pop screen and return the patient map
                    },
                    child: Container(
