...
class _LayananTensiScreenState extends State<LayananTensiScreen> {
  ...
  // Realistic mock patient data with specific BP parameters
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        '92% dari target bulanan selesai',
                        style: GoogleFonts.plusJakartaSans(
                          fontSize: 11,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildLegendItem('Normal', AppColors.primary),
              _buildLegendItem('Pre-Hipertensi', AppColors.statusWarning),
              _buildLegendItem('Hipertensi', AppColors.error),
            ],
          ),
        ],
      ),
