...
class RiwayatPemeriksaanScreen extends StatefulWidget {
  ...
  const RiwayatPemeriksaanScreen({
    ...
    this.age = '65',
    this.imageUrl = 'https://lh3.googleusercontent.com/aida-public/AB6AXuBP2mwpvzOcwZbSzF2VDDw_XdAdiSVX9vedl4FuMv5TjtLcPLKybRdGVRprGWlMMiHNhsUP5Ktxoi3NODyPnBsoMd9dYcMXVz03fqc3gBVj16ZuNScqYU17oJMLFSx653nKLB61j6cZqVzT9eH_ZmX8LulWE4M81PbPSscRNdTURl11zBJ-jv1LZItJindbkQUEmt0iiv3kP9w0SlirAAh3Xil0V_NtffDcna4MVqO8yziYzxhv6llBrCiYDnAjODVV3oi_9Rj0APdT',
  });
...
class _RiwayatPemeriksaanScreenState extends State<RiwayatPemeriksaanScreen> {
  ...
  DateTime? _endDate = DateTime(2026, 5, 24);
            ...
            if (_filteredRecords.isEmpty)
              ...
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildCheckupCard(record, showDetailButton: index == 2 || record.day == 'Rabu');
                },
              ),
          ],
        ),
